...
class Logs extends \yii\db\ActiveRecord
{
    ...
    public function getBrowser(){
        ...
        if (!is_null($data)) {
            foreach ($data as $value) {$array[] = array($value['browser'],(int)$value['count']);}
            return $array;
        }
    }
    ...
    public function getLanguage(){
        ...
        foreach($data as $value) {$array[] = array($value['language'], (int)$value['count']);}
        if (!is_null($data)) {
            return $array;
        }
    }
    ...
    public function getOs(){
        ...
        foreach ($data as $value){$array[] = array($value['os'], (int)$value['count']);}
        if (!is_null($data)) {
            return $array;
        }
    }
    ...
    public function getDevice(){
        ...
        if (!is_null($data)) {
            foreach ($data as $value){$array[] = array($value['device'], (int)$value['count']);}
            return $array;
        }
    }

...
class Logs extends \yii\db\ActiveRecord
{
    ...
    public function getCategories()
    {
        ...
        if (!is_null($data)) {
            foreach ($data as $value) {
                $array[] = array($value['name'],(int)$value['visits']);
            }
            return $array;
        }
    }
    ...
    public function getVisits()
    {
        ...
        if (!is_null($data)) {
            foreach ($data as $value) {
                $array[] = array($value['title'],(int)$value['count']);
            }
            return $array;
        }
    }
    ...
    public function getReferrer()
    {
        ...
        if (!is_null($data)) {
            foreach ($data as $value) {
                $array[] = array($value['referrer'], (int)$value['count']);
            }
            return $array;
        }
    }
    ...
    public function getType()
    {
        ...
        if (!is_null($data)) {
            foreach ($data as $value) {
                $array[] = array($value['type'], (int)$value['count']);
            }
            return $array;
        }
    }
